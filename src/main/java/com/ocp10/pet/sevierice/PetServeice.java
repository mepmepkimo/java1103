package com.ocp10.pet.sevierice;
...
//取得所有寵物的價格
    ...
    public void print(Pet[] pets) {
        for (Pet pet : pets) {
            ...
            System.out.printf("%s價格: %d 飲食", className, price);
            pet.eat();
        }
    }
    ...
    //印出每一個寵物的總價
    public void printEachToTatalPriceByPet(Pet[] pets) {
        Class[] clazzes = {Chihuahua.class, Shiba.class, Egod.class};
    ...
    public void printTheHighestPriceByPet(Pet[] pets) {
        Pet p = null;
        for (Pet pet : pets) {
            if (p == null) {
                p = pet;
